...
import styles from './AddSquash.module.scss'
...
const AddSquash = (props) => {
  ...
  return (
    <div className={styles.wrapper}>
      {showToast && <Toast toastType="success" toastTitle="Complete add squash."/>  }
